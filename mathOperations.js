...
var $exeDevice = {
    ...
    ci18n: {
        ...
        "msgTryAgain": ("You need at least %s&percnt; of correct answers to get the information. Please try again."),
        ...
        "msgCheck": ("Check"),
        "msgWithoutAnswer": ("Not answered"),
        "msgReplied": ("Answered"),
        "msgCorrects": ("Right"),
        "msgIncorrects": ("Wrong"),
        "msgIncomplete": ("Not completed"),
        "msgEndTime": ("Time over."),
        "msgAllOperations": ("You finished all the operations."),
        "msgFracctionNoValid": ("Write a valid fraction."),
        "msgOperatNotValid": ("Write a valid operator: +-x*/:"),
        "msgNewGame": ("Click here to play"),
    ...
    createForm: function () {
        var html = '\
			<div id="gameQEIdeviceForm">\
                <div class="exe-idevice-info">' + _("Create basic math operation games (addition, subtraction, multiplication, division). The student will have to guess the result, operator or an operand.") + ' <a href="https://descargas.intef.es/cedec/exe_learning/Manuales/manual_exe29/operaciones_matemticas.html" hreflang="es" target="_blank">' + _("Use Instructions") + '</a></div>\
...
// mathOperations.js
function performOperation(operandA, operandB, operation) {
    switch (operation) {
        case 'add':
        ...
        case 'multiply':
            return operandA * operandB;
        case 'divide':
            return operandB !== 0 ? operandA / operandB : Infinity; // Manejo de división entre 0
        default:
            throw new Error('Operación no soportada');
    }
}

module.exports = { performOperation, $exeDevice };
